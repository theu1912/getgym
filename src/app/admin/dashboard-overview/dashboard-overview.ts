          ...
          <div class="chart-wrapper">
            <div class="bar-col" *ngFor="let peak of peakHours">
              <div class="bar-bg">
                ...
                <div class="bar-fill"
                     [style.height.%]="barHeight(peak.visitors)"
        ...
        <div class="panel">
          ...
          <ul class="source-list">
            <li class="source-item">
              <div class="source-info"><span class="dot site"></span> Site Oficial</div>
              <div>
            ...
            <li class="source-item">
              <div class="source-info"><span class="dot presencial"></span> Balcão / Presencial</div>
              <div>
            ...
            <li class="source-item">
              <div class="source-info"><span class="dot gympass"></span> Plataformas (Gympass)</div>
              <div>
...
export class DashboardOverviewComponent implements OnInit {
  peakHours: any[] = [];
  maxVisitors = 1; // calculado dinamicamente após carregar os dados
    ...
    this.http.get<any>(`${environment.apiUrl}/api/dashboard/visao-geral`, { headers: this.headers })
      .subscribe({
        next: (dados) => {
          ...
          this.peakHours  = dados.peakHours;
          this.origens    = dados.origens;
          // Calcula o máximo real para escalar as barras corretamente
          this.maxVisitors = Math.max(...this.peakHours.map((h: any) => h.visitors), 1);
  ...
  /** Retorna a altura percentual da barra, limitada a 100% */
